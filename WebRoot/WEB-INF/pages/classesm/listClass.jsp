...
<table border="0" cellspacing="0" cellpadding="0" class="wukuang">
  <tr>
    ...
    <td width="36%"align="right">
    	...
    	<a href="${pageContext.request.contextPath}/classesAction_addOrEditUI">
...
<thead>
  <tr class="henglan" style="font-weight:bold;">
	...
	<th width="50px" align="center">删除</th>
  ...
  <tbody>
	  ...
	  <tr class="tabtd2">
	   ...
	   <!--  <td align="center"><s:property value="status" /></td>
	    ...
	    <td align="center"><s:property value="runoffCount" /> </td> -->
	    <td align="center">
	    	<s:a action="classesAction_addOrEditUI">
	    		<s:param name="classId" value="classId"></s:param>
	    		<img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/>
	    	</s:a>
	    </td>
		<td align="center">
			<s:a action="classesAction_show" namespace="/">
				<s:param name="classId" value="classId"></s:param>
				<img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/>
			</s:a>
		</td>
		<td width="11%" align="center">
	  		<s:a action="classesAction_delete" namespace="/" onclick="return confirm('您确定要删除?') " >
	  			<s:param name="classId" value="classId"></s:param>
		...
		<td align="center" title="上次上传时间：2015-04-02">   
			<s:a action="classesAction_uploadUI" namespace="/" >上传
				<s:param name="classId" value="classId"></s:param>
			</s:a>
			<s:if test="uploadFilename!=null">
				<s:a action="classesAction_download" namespace="/"  >下载:<s:property value="uploadFilename"/>
				<s:param name="classId" value="classId"></s:param>
			</s:a>
			</s:if>
			...
			<s:if test="uploadPath!=null">
				<span>已上传课表</span>
			</s:if>
			<s:if test="uploadPath==null">
				<span style="color:red">未上传课表</span>
			</s:if>
