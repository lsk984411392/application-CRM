...
<s:form  action="courseTypeAction_addOrEditCourse" namespace="/" >
<form  action="courseTypeAction_addOrEdit.action" method="post">
	...
	<!-- //因为编辑和添加是一个页面，添加时如果<s:hidden name="courseTypeId"></s:hidden>存在，模型会获得id为空字符串，执行saveOrUpdate方法将报错 -->
	...
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	  ...
	  <tr>
	    <td colspan="4"></textarea><s:textarea name="remark" cols="60" rows="10"></s:textarea>  </td>
	  </tr>
	</table>
</s:form>
</body>
